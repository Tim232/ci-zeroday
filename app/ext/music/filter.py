...
class SafetySearch:
    ...
    def __init__(self):
        ...
        # Mongo DB Credential
        self.MongoDB_URL = config[3].db_url
        self.MongoDB_PORT = config[3].db_port

        # NAVER API Authentication
        self.headers = {
            "X-Naver-Client-Id": config[2].X_Naver_Client_Id,
            "X-Naver-Client-Secret": config[2].X_Naver_Client_Secret,
        }
